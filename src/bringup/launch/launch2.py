...
def generate_launch_description():
    ...
    list = [
        ...
        Node(
            package='mapd_client',
            executable='mapd_client',
            output='screen'
        ),
        Node(
            package='mapd_simulator',
            executable='mapd_simulator',
            output='screen'
        ),
        Node(
            package='mapd_interpolation',
            executable='mapd_interpolation',
            output='screen'
        ),
        Node(
            package='mapd_followup',
            executable='mapd_followup',
            output='screen'
        ),
        # Node(
